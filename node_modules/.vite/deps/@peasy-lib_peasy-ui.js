...
var UIView = class _UIView {
  ...
  updateToUI() {
    var _a, _b, _c, _d, _e;
    const t2 = this.element instanceof Comment && this.state === "created";
    if (!t2) {
    ...
    switch (this.state) {
      case "created":
        ...
        if (!(((_c = (_b = this.element).hasAttribute) == null ? void 0 : _c.call(_b, "PUI-UNRENDERED")) ?? false))
          (this.parentElement ?? s.parentElement(this.element, this.parent)).insertBefore(this.element, ((_d = this.sibling) == null ? void 0 : _d.nextSibling) ?? null);
        this.attachResolve();
          ...
          for (let t3 = o, e3 = r.length, i3 = o; t3 < e3; t3++, i3++) {
            ...
            if (i4 == null) {
              ...
              const i5 = UIView.create(this.element.parentElement, t4, this.template.cloneNode(true), {
                parent: this,
                prepare: false,
                sibling: (u == null ? void 0 : u.element) ?? this.element
              });
              a.push(i5);
              u = i5;
              continue;
            ...
            if (h2 === o2) {
              a.push(i4);
              i4.move((u == null ? void 0 : u.element) ?? this.element);
              u = i4;
              continue;
            }
            ...
            for (let t4 = 0, e5 = this.views.length; t4 < e5; t4++) {
              ...
              if (h2 === r2) {
                a.push(...this.views.splice(t4, 1));
                e6.move((u == null ? void 0 : u.element) ?? this.element);
                c = true;
                u = e6;
                break;
              }
  ...
  static parse(t2, e2, i2, n) {
    ...
    if (t2.nodeType === 3) {
      ...
      h.push(...Object.keys(t2.attributes ?? []).reverse().map((h2) => {
        ...
        if (l.name.startsWith("pui.")) {
          ...
          if (o2 !== "@") {
            ...
            if (s3 != null) {
              ...
              if (a2 === ">") {
                const { target: i3, property: s4 } = this.resolveProperty(e2, u2);
                i3[s4] = t2;
                return [];
              } else {
        ...
        while (u != null) {
          let { before: n2, property: h3, after: c } = u.groups;
          let f = false;
          if (h3.startsWith("|")) {
            f = true;
