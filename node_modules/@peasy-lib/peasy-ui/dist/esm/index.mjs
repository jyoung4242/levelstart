class UIView {
    ...
    updateToUI() {
        const t = this.element instanceof Comment && this.state === "created";
        if (!t) {
        ...
        switch (this.state) {
          case "created":
            ...
            if (!(this.element.hasAttribute?.("PUI-UNRENDERED") ?? false)) (this.parentElement ?? s.parentElement(this.element, this.parent)).insertBefore(this.element, this.sibling?.nextSibling ?? null);
            this.attachResolve();
            ...
            for (let t = o, e = r.length, i = o; t < e; t++, i++) {
                ...
                if (i == null) {
                    ...
                    const i = UIView.create(this.element.parentElement, t, this.template.cloneNode(true), {
                        parent: this,
                        prepare: false,
                        sibling: u?.element ?? this.element
                    });
                    a.push(i);
                    u = i;
                    continue;
                ...
                for (let t = 0, e = this.views.length; t < e; t++) {
                    ...
                    if (h === r) {
                        a.push(...this.views.splice(t, 1));
                        e.move(u?.element ?? this.element);
                        c = true;
                        u = e;
                        break;
                    }
    ...
    static parse(t, e, i, n) {
        ...
        if (t.nodeType === 3) {
            ...
            while (r != null) {
                ...
                const u = o.match(this.regexConditionalValue);
                let c;
                let f = true;
                if (o.startsWith("(")) {
            ...
            h.push(...Object.keys(t.attributes ?? []).reverse().map((h => {
                ...
                if (l.name.startsWith("pui.")) {
                    ...
                    if (o !== "@") {
                        ...
                        if (s != null) {
                            ...
                            const {target: i, property: s} = this.resolveProperty(e, u);
                            i[s] = t;
                            return [];
                        } else {
                            ...
                            f = r;
                            o = true;
                        } else if (a === "*") ({element: t, template: f} = this.replaceWithComment(t, i, n, l.name)); else if (a === "|") p = true; else if (r !== "checked") t.setAttribute(r, t.getAttribute?.(r) ?? "");
                    }
                    return [ this.bind({
                        selector: t,
                        attribute: r,
                ...
                const o = [ l.value ];
                let a = 0;
                let u = o[a].match(this.regexValue);
                while (u != null) {
                    let {before: n, property: h, after: c} = u.groups;
                    let f = false;
                    if (h.startsWith("|")) {
                        f = true;
    ...
    static parseAttribute(t, e, i, s, n, h) {
        ...
        if (a !== "@") {
            ...
            if (h != null) {
                ...
                m = true;
                a = true;
            } else if (u === "*") ({element: t, template: p} = this.replaceWithComment(t, i, s, n)); else if (u === "|") m = true; else if (o !== "checked") t.setAttribute(o, "");
        }
        return [ this.bind({
            selector: t,
            attribute: o,
